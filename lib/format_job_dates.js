...
const formatDatesToStrings =
  evolve({
    jobStartDate: dateToString,
    jobEndDate: dateToString,
    invoiceDate: dateToString,
    invoiceDueDate: dateToString,
  });

const formatStringsToDates =
  evolve({
    jobStartDate: stringToDate,
    jobEndDate: stringToDate,
    invoiceDate: stringToDate,
    invoiceDueDate: stringToDate,
  });
